...
const TransactionCard = ({addressTo, addressFrom, timestamp, message, keyword, amount, url}) => {
    ...
    return (<div className="bg-[#181918] m-4 flex flex-1
        ...
        <div className="flex flex-col items-center w-full mt-3">
            ...
            <img src={gifUrl || url} alt="gif" className="w-full h-46 2xl:h-96 rounded-md shadow-lg object-cover max-h-[260px] "/>
    ...
    return (<div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
        <div className="flex flex-col md:p-12 py-12 px-4">
            {currentAccount ? (<h3 className="text-white text-3xl text-center my-2">Latest Transactions</h3>) : (
                <h3 className="text-white text-3xl text-center my-2">Connect your account to see the latest
                    changes</h3>)}
