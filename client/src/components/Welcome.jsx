...
import {AiFillPlayCircle} from "react-icons/all.js";
import {SiEthereum} from "react-icons/all.js";
import {BsInfoCircle} from "react-icons/all.js";
        ...
        <div className="flex w-ful justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">Send Crypto <br/> across the
                        world</h1>
                        ...
                        <div className="flex justify-between flex-col w-full h-full">
                            ...
                            <div>
                                <p className="text-white font-light text-sm">
                                    {/*{shortenAddress(currentAccount)}*/} Adreess
                                </p>
